...
Tanto el bloxplot de la variable Height, como de la Weight nos marcan valores fuera del 1. 5 intercuartil que podríamos considerar outliers (!). En concreto, si nos fijamos en la variable Height, podemos ver que corresponden a la siguiente lista.
