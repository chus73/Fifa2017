...
fifa.pca <- prcomp(fifa.df.sub[, col_names], center = TRUE, scale. = TRUE)
summary(fifa.pca)
```
Vemos que la proporción de varianza no proporciona buenos resultados. Como hemos visto anteriormente, la correlación entre las variables era escasa.
