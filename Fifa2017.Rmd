...
```
Encontramos que con la primera componente, apenas se supera el 10 % de la varianza. Es por ello, que si no queremos bajar la fiabilidad del modelo, no podemos prescindir de ninguna de las componentes.
